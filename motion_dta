...
varnames<-read.table("~/Documents/coursera/getting and cleaning data/data/UCI HAR Dataset/features.txt", quote="\"", comment.char="")
varnames1<-as.character(varnames$V2)

#Import Data for test subjects
y_test <- read.table("~/Documents/coursera/getting and cleaning data/data/UCI HAR Dataset/test/y_test.txt", quote="\"", comment.char="")
x_test <- read.table("~/Documents/coursera/getting and cleaning data/data/UCI HAR Dataset/test/X_test.txt", quote="\"", comment.char="")
subject_test <- read.table("~/Documents/coursera/getting and cleaning data/data/UCI HAR Dataset/test/subject_test.txt", quote="\"", comment.char="")
names(x_test)<-varnames1 #Apply appropriate variable names

#Import Data for train subjects
y_train <- read.table("~/Documents/coursera/getting and cleaning data/data/UCI HAR Dataset/train/y_train.txt", quote="\"", comment.char="")
x_train <- read.table("~/Documents/coursera/getting and cleaning data/data/UCI HAR Dataset/train/X_train.txt", quote="\"", comment.char="")
subject_train <- read.table("~/Documents/coursera/getting and cleaning data/data/UCI HAR Dataset/train/subject_train.txt", quote="\"", comment.char="")
